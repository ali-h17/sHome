...
Command: npx gltfjsx@6.2.15 house_v2.glb 
*/
...
export default function Model(props) {
	const group = useRef();
	const { nodes, materials, animations } = useGLTF('/house_v2.glb');
	const { actions } = useAnimations(animations, group);
  console.log(actions);

  useEffect(() => {
    if (actions.CloseGarage) {
